"main";let geocode;_e9c‍.w("./utils/geocode.mjs",[["default",function(v){geocode=v}]]);let forecast;_e9c‍.w("./utils/forecast.mjs",[["default",function(v){forecast=v}]]);let request;_e9c‍.w("request",[["default",function(v){request=v}]]);let chalk;_e9c‍.w("chalk",[["default",function(v){chalk=v}]]);
...
geocode('Suzano', (error, data) => {
    ...
    forecast(data.longitude, data.latitude, (nError, nData) => {
